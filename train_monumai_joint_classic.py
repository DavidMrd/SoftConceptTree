...
def train(model, args):
    ...
    train_dataset, val_dataset, test_dataset  = get_dataset(train_file='MonuMAI/csv/train_onehot_seed'+str(args.seed)+'.csv', val_file='MonuMAI/csv/val_onehot_seed'+str(args.seed)+'.csv', test_file = 'MonuMAI/csv/test_onehot_seed'+str(args.seed)+'.csv' , use_attr = args.use_attr, no_img = args.no_img, use_inception = args.use_inception)
...
def parse_arguments(experiment):
    ...
    parser.add_argument('exp', type=str,
                        choices=[ 'Joint_SoftDecisionTreeClassic'],
